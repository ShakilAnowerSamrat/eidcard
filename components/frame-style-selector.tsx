  ...
  return (
    <Card className="bg-white/90 dark:bg-gray-800/90 backdrop-blur-sm border-emerald-200 dark:border-emerald-600">
      <CardHeader className="pb-4">
        <CardTitle className="text-emerald-800 dark:text-emerald-100">Frame Styles</CardTitle>
      </CardHeader>
      <CardContent>
          ...
          {frameStyles.map((style) => {
            ...
            return (
              <Button
                ...
                className={`h-auto p-3 sm:p-4 flex flex-col space-y-2 text-left ${
                  selectedStyle === style.id
                    ? "bg-emerald-600 hover:bg-emerald-700 text-white"
                    : "border-emerald-200 dark:border-emerald-600 hover:bg-emerald-50 dark:hover:bg-emerald-900/20 dark:text-gray-200"
                }`}
