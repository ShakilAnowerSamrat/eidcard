  ...
  return (
    ...
    >
      <CardContent className="p-6 space-y-6">
        ...
        >
          <p className="text-gray-700 dark:text-gray-800 text-center leading-relaxed">{message}</p>
        </div>
    ...
    >
      ...
      <CardContent className="p-8 space-y-6">
        ...
        >
          ...
          <p className="text-gray-700 dark:text-gray-800 text-center leading-relaxed italic">{message}</p>
        </div>
      ...
      <CardContent className="p-8 space-y-6 relative z-10">
        ...
        <div className="space-y-4">
          ...
          <div className="p-6 rounded-2xl" style={{ backgroundColor: `${customColors.primary}08` }}>
            <p className="text-gray-700 dark:text-gray-800 leading-relaxed">{message}</p>
          </div>
    ...
    >
      ...
      <CardContent className="p-8 space-y-6 relative z-10">
        ...
        >
          ...
          <p className="text-gray-700 dark:text-gray-800 text-center leading-relaxed font-medium">{message}</p>
        </div>
